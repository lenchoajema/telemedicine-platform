...
// GET /api/discovery/pharmacies?near=lat,lng&query=&drugId=&page=
router.get('/pharmacies', async (req, res) => {
  try {
    const { near, query, page } = req.query;
...
// GET /api/discovery/pharmacies/:id/inventory?drugId=
...
// GET /api/discovery/labs?near=&query=&testCode=&page=
...
// GET /api/discovery/labs/:id/tests?activeOnly=true
