...
export default function LaboratoryProfileEditPage() {
    ...
    async function load() {
      try {
        ...
        if (e?.response?.status === 404) {
          setError("No laboratory profile found. Please register first.");
        } else {
  ...
  const onSave = async (e) => {
    ...
    try {
      ...
      setTimeout(() => navigate("/laboratory/portal"), 800);
    } catch (e2) {
