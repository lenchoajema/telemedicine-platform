...
const AdminUsersManagement = () => {
  ...
  const handlePasswordReset = async (e) => {
    ...
    try {
      const response = await apiClient.post(`/admin/users/${passwordResetData.userId}/reset-password`, {
              ...
              <tr key={user._id}>
                <td className="user-info">
                  <div className="user-avatar">
                    {(user.firstName || user.profile?.firstName || 'U')[0]}{(user.lastName || user.profile?.lastName || 'N')[0]}
                  </div>
                  <div className="user-details">
                    <div className="user-name">{user.firstName || user.profile?.firstName || 'Unknown'} {user.lastName || user.profile?.lastName || 'User'}</div>
                  ...
                  <div className="actions-dropdown">
                    ...
                    {showDropdown === user._id && (
                      <div className="dropdown-menu">
                        <button
                          onClick={() => {
                            setPasswordResetData({ ...passwordResetData, userId: user._id });
